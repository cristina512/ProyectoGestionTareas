...
import org.example.gestiontareas.BD.ConexionBD
import org.example.gestiontareas.BD.SQL_Proyecto
import org.example.gestiontareas.NEGOCIO.Proyecto

class ProyectoDAOImpl: ProyectoDAO {
    ...
    override fun getAllProyectos(): List<Proyecto> {
        conexion.conectar()
